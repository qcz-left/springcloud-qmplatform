package com.qcz.qmplatform.sms.service.tencent;
...
public class TencentCloudSmsNotifyService implements INotifyService {
    ...
    public void send() {
        try {
            ...
            List<String> phones = smsConfig.getPhones();
            req.setPhoneNumberSet(phones.toArray(new String[phones.size()]));

            /* 模板参数: 若无模板参数，则设置为空*/
            Collection<String> templateParams = smsConfig.getTemplateParams().values();
